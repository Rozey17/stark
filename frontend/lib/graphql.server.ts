...
const authLink = setContext((_, { headers }) => {
  ...
  const token =
    "skBjeDbWGfGOnR6h60tBCtKmIvVCnEODdsj5mGv4qTpzUn1juIJKoTcSpopKiKQIHtP0FwQxStmd85RTESxr66NYeGK7JaTLe6nSaymWd1X0icamBHiIfZkMlUVWxCZSedxOnTtGdNtN6YzdXzI5np29DrCOiTdMrl4tG9IYi4OHLqhA9A6g";
...
const httpLink = createHttpLink({
  uri: "https://c0oblyev.api.sanity.io/v1/graphql/dataset/default",
});
